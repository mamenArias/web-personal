    ...
    <div className='index'>
      <div className='introduction'>
        <section className='personal-text'>
            <animated.h1 style={{opacity, transition: '500ms'}}><strong>¡Buenas!</strong><br/><br/>
              Mi nombre es Mª Carmen Arias, aunque me llaman Mamen, y soy  
              <br/><strong className='text-strong'> Técnico Superior de Desarrollo de Aplicaciones Multiplataforma. </strong></animated.h1>
              <animated.p style={{opacity, transition: '500ms'}}>Estudié el Grado de Fisioterapia en 2009 y el Máster en Osteopatía en 2013, y he trabajado como fisioterapeuta
